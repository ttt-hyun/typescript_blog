...
const UtilSearch = ({ keyword, isAvailable, handleClick }: UtilSearchProps) => {
    return (
        <button
            type={"button"}
            onClick={handleClick}
            className="search__button shadow-primary flex justify-between items-center px-4 w-full h-[42px] bg-white dark:bg-default border-solid rounded-md border-gray-300 hover:border-gray-400 dark:bg-default" >
