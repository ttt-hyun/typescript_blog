...
const getPosts = (keyword: string) => {
    return posts.filter(res => res.title.includes(keyword)).map(res => (
        {
            'title' : res.title
        }
    ));
...
const ModalMenu = ({ children, isOpen, handleClose }: ModalDefaultProps) => {
    ...
    const [searchResultArray, setSearchResultArray] = useState<[{title: string}] | null>();
    ...
    const keyWordChange = (e: React.ChangeEvent<HTMLInputElement>): void => {
        ...
        searchResult.length !== 0 ? setSearchResultArray(searchResult) : setSearchResultArray(null);
    }
    ...
    return (
        <ReactPortal wrapperId="react-portal-modalsearch">
            <>
                ...
                >
                    <div className="bg-white py-5 w-full max-w-[700px] shadow-primary rounded-md">
                        <div className="search__header px-5">
                            ...
                            <div className="search__keyword pt-1">
                                <input
                                    type="text"
                                    className="w-full h-[42px]  placeholder:text-md"
                                ...
                                >
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20">
                                            <g data-name="Circle kanan">
                                                ...
                                                <path d="M11 16a1 1 0 0 1-.707-1.707L12.586 12l-2.293-2.293a1 1 0 0 1 1.414-1.414l3 3a1 1 0 0 1 0 1.414l-3 3A1 1 0 0 1 11 16z" className=""/></g>
                                        </svg>
                                    </Link>
                                </li>
                            </ul>
